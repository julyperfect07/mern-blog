        ...
        {isEditing ? (
          <>
            ...
            <div className=" flex justify-end gap-2 text-xs">
              <Button type='button' size='sm' gradientDuoTone='purpleToBlue' onClick={handleSave} className=''>Save</Button>
              <Button onClick={() => setIsEditing(false)} type='button' size='sm' gradientDuoTone='purpleToBlue' outline className=''>Cancel</Button>
            </div>
          </>
        ) : (
          <>
            <p className=' dark:text-white text-gray-500 pb-2'>{comment.content}</p>
